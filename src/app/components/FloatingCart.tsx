...
import { getItemSubtotal, getEffectiveUnitPrice } from '@/lib/priceUtils';
                ...
                <div key={item.id} className="border-b border-gray-100 pb-3">
                  <div className="flex justify-between items-start mb-2">
                    <p className="text-[11px] font-black text-foreground uppercase leading-tight flex-1">
                      {esOferta && <span className="text-red-500 mr-1">🔥</span>}
                      {item.name}
                    </p>
                    ...
                    {item.qtyUnidad > 0 && (
                      <div className="flex justify-between items-center text-[10px] text-muted-foreground bg-gray-50 p-1 rounded border border-black/5">
                        ...
                        <button 
                          ...
                          className="text-red-400 hover:text-red-600 font-bold uppercase text-[9px]"
                        >
                          Quitar
                        </button>
                      </div>
